# calibration_eval
install.packages('RHESSysIOinR')
install.packages('rhutils')
...
library(hydroGOF)
library(data.table)
source("~/Documents/Github/rhessys-calibration/misc_utils.R")
setwd('~/Documents/Modeling/spanishcreek/calibration')
#load("r_obj/std_cal_inputs.rdata")

#out_dir = "output/rh_out_2022-11-19--11-54-24/"

Qobs = fread("calibstreamflow.csv") ##in ft2/sec
Qobs$Flow_mmd <- Qobs$discharge * 86400 * 92903

##area of basin m2 471402723.133291
# CHECK IF IN MM
out_dir = '~/Documents/Modeling/spanishcreek/calibration'
